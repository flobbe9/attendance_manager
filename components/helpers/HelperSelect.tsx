...
export default function HelperSelect({
        ...
        return options
            .map((option, i) => 
                ...
                >
                    ...
                    {selectedOptions.has(option) && <FontAwesome name="check" style={HelperSelectStyles.optionButtonText.default} />}
                </HelperButton>
            );
    }
    ...
    function getSelectionButtonValue(): string {
        ...
        if (!options || !selectedOptions || !selectedOptions.size)
    ...
    return (
        <HelperView {...otherProps}>
            ...
            >
                <Text style={{...HelperSelectStyles.selectionButtonValue.default, opacity: selectedOptions.size ? 1 : 0.5}}>
