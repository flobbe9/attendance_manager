# Attendance Manager Android / iOS app

## Run locally
- `npm i`
- connect your cell phone via USB or start up an emulator
    - make sure your phone and your pc are using the same network and not using a VPN
- For Android:
