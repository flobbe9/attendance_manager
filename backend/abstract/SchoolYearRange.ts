...
export function isSchoolYearRangeOverlap(schoolYearRange1: SchoolYearRange, schoolYearRange2: SchoolYearRange, includeEdges = true): boolean {
    ...
    if ((!schoolYearRange1.min && !schoolYearRange1.max) || (!schoolYearRange2.min && !schoolYearRange2.max))
        return true;

    const range1OverlapsRange2 = isWithinSchoolYearRange(schoolYearRange1.min, schoolYearRange2, includeEdges) || isWithinSchoolYearRange(schoolYearRange1.max, schoolYearRange2, includeEdges);
    const range2OverlapsRange1 = isWithinSchoolYearRange(schoolYearRange2.min, schoolYearRange1, includeEdges) || isWithinSchoolYearRange(schoolYearRange2.max, schoolYearRange1, includeEdges);
 ...
 * @returns the differential of `schoolYearRange.max - schoolYearRange.max`. 
