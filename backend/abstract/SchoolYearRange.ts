 ...
 */
export function isWithinSchoolYearRange(
 ...
 */
export function isSchoolYearRangeOverlap(
    schoolYearRange1: SchoolYearRange,
    schoolYearRange2: SchoolYearRange,
    includeEdges = true
): boolean {
    ...
    if (
        (!schoolYearRange1.min && !schoolYearRange1.max) ||
        (!schoolYearRange2.min && !schoolYearRange2.max)
    )
        return true;
 ...
 */
export function equalsSchoolYearRange(
    schoolYearRange1: SchoolYearRange,
    schoolYearRange2: SchoolYearRange
): boolean {
    ...
    return (
        defaultEquals(schoolYearRange1.min, schoolYearRange2.min) &&
 ...
 * @returns
 */
export function compareSchoolYearRangeSizes(
    schoolYearRange1: SchoolYearRange,
    schoolYearRange2: SchoolYearRange
): number {
