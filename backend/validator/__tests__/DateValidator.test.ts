...
describe("validateContextConditions", () => {
    ...
    test("Should be invalid if same examinant is planned more than once", () => {
        ...
        expect(
            validator.validateContextConditions([], currentAttendanceEntity.date)
        ).not.toBeNull();
